...
void MainWindow::on_removeButton_clicked()
{
   ...
   // DataCollection.SetNumData(0);
    for(int i = 0; i < TempE.GetNumData(); i++)
    {
       ...
       /* DataCollection.SetTitle(TempE.GetTitle(i));
        DataCollection.SetDesc(TempE.GetTitle(i));
        DataCollection.SetTime(TempE.GetTitle(i));
        DataCollection.SetDate(TempE.GetTitle(i));
